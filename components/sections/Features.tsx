...
function Features() {
  return (
    <div className="bg-aircraft-white">
      <div className="flex flex-col items-center px-6 py-20 text-center xl:container xl:px-20 gap-y-20 sm:gap-y-24 sm:py-24 xl:py-36 xl:gapy-36 xl:pb-24">
        <Hooks
